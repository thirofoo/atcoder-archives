/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc278/submissions/36648202
 * Submitted at: 2022-11-19 23:24:39
 * Problem URL: https://atcoder.jp/contests/abc278/tasks/abc278_f
 * Result: AC
 * Execution Time: 1075 ms
 */
...
bool dfs(int j,int k,int p){
    ...
    if(mp.count(P(j,k)))return mp[P(j,k)];
    bool f = false;
    rep(i,n){
