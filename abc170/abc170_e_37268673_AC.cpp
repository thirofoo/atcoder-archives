/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc170/submissions/37268673
 * Submitted at: 2022-12-14 20:05:07
...
int main() {
    ...
    while(q--){
        ...
        else sg.set(school[c],*info[school[c]].rbegin());
        sg.set(d,*info[d].rbegin());
