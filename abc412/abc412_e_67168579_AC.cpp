/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc412/submissions/67168579
 * Submitted at: 2025-06-28 23:36:34
...
int main() {
  ...
  rep(i, 1e7 + 1) {
    ...
    __int128_t v1 = 1;
    ll cnt1       = 0;
    while(v1 < (__int128_t) l) {
      v1 *= (__int128_t) i;
      cnt1++;
    }
    __int128_t v2 = 1;
    ll cnt2       = 0;
    while(v2 <= (__int128_t) r) {
      v2 *= (__int128_t) i;
      cnt2++;
    }
    ans += (cnt2 - cnt1);
    if(v1 == (__int128_t) i && v1 <= (__int128_t) r) ans--;
  }
  cout << ans << endl;
