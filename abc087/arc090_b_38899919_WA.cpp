/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc087/submissions/38899919
 * Submitted at: 2023-02-15 14:33:12
...
int main() {
    ...
    weighted_dsu wuf(n);
    rep(i,m){
        ll l,r,d; input(l,r,d);
        l--; r--;
        if(l > r)swap(l,r);
        // 右程 potential が高いとして重み付きUF
        if(wuf.same(l,r) && wuf.diff(l,r) != d)return print("No"),0;
        else wuf.merge(l,r,d);
    }
    print("Yes");
