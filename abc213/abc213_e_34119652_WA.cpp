/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc213/submissions/34119652
 * Submitted at: 2022-08-18 12:50:04
...
int main() {
    ...
    while(!todo.empty()){
        ...
        rep(l,4){
            ...
            if(!outField(nx,ny) && field[nx][ny] == '.' && visited[x][y] > c)todo.push(T(c,nx,ny));
        }
        rep(l,20){
            int nx = x+dx2[l],ny = y+dy2[l];
            if(!outField(nx,ny) && visited[x][y] > c+1)todo.push(T(c+1,nx,ny));
        }
    }
