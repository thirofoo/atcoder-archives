/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc270/submissions/35149096
 * Submitted at: 2022-09-25 09:21:31
...
int main() {
    ...
    while(!todo.empty()){
        ...
        if((uf.same(n,n+1) && uf.size(n) == n+2) || (!uf.same(n,n+1) && ((uf.size(n) == n+1) || (uf.size(n+1) == n+1))) || (!uf.same(0,n) && !uf.same(0,n+1) && uf.size(0) == n) )break;
    }
    print(ans);
