/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/future-contest-2018-qual/submissions/31156921
 * Submitted at: 2022-04-22 22:33:21
 * Problem URL: https://atcoder.jp/contests/future-contest-2018-qual/tasks/future_contest_2018_qual_a
 * Result: AC
 * Execution Time: 5968 ms
 */
...
int main() {
    ...
    //処理パート
    while(utility::mytm.elapsed() <= 5950){
        vector<T> tmp;
        rep(i,1000){
            int x = randInt()%100;
            int y = randInt()%100;
