/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc159/submissions/46036756
 * Submitted at: 2023-09-29 23:44:36
...
int main() {
    ...
    vector<pair<int,mint>> tmp = {pair(0,1)};
    mint ans = 0;
    rep(i,n) {
        tmp.emplace_back(pair(a[i],1));
        fps[0]++;
        fps *= tmp;
        ans += fps[s];
        tmp.pop_back();
