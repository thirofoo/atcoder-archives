/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc383/submissions/60517547
 * Submitted at: 2024-12-07 21:22:06
...
int main() {
  ...
  while(!q.empty()) {
    ...
    rep(k, DIR_NUM) {
      ll nx = x + dx[k];
      ll ny = y + dy[k];
      if(outField({nx, ny}, h, w) || visited[nx][ny] <= dis + 1 || s[nx][ny] == '#') continue;
