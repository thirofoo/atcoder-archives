/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc343/submissions/50865825
 * Submitted at: 2024-03-03 15:01:36
...
int main() {
    ...
    rep(i, (1ll << n)-1) rep(j,n) {
        ...
        rep(k,n) {
            ...
            dp[ni][k] = min(dp[ni][k], dp[i][j] + (ll)s[k].size() - duplicate[j][k]);
        }
    }
    ll ans = 1e16;
