/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc343/submissions/50822008
 * Submitted at: 2024-03-02 21:53:01
...
int main() {
    ...
    // 14 * 14 * 14 の空間に1つ置き、残り2つの配置を全探索
    vector<vector<vector<ll>>> cnt(2*n, vector<vector<ll>>(2*n, vector<ll>(2*n,0)));
    ...
    reps(x1,0,n+1) reps(y1,0,n+1) reps(z1,0,n+1) {
        ...
        reps(x2,0,n+1) reps(y2,0,n+1) reps(z2,0,n+1) {
            rep(dx,n) rep(dy,n) rep(dz,n) {
