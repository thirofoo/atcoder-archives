/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc276/submissions/36240316
 * Submitted at: 2022-11-05 21:29:20
...
int main() {
    ...
    vector<P> tp = factorize(e);

    ll c1 = 0,c2 = 0;
    for(auto [num,c]:tp){
        if(num == 2)c1 = num;
        else if(num == 3)c2 = num;
        else break;
    }
