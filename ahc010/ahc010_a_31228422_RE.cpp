/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc010/submissions/31228422
 * Submitted at: 2022-04-24 16:42:42
    ...
    rep(i,30){
        rep(j,30){
            rep(k,4){
                ...
                else if(tmp_l > length2)length1 = tmp_l;
