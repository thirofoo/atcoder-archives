/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc331/submissions/48129280
 * Submitted at: 2023-12-02 21:50:18
...
int main() {
    ...
    rep(i,n) {
        rep(j,m) {
            if( pq.size() < 2*(l+10) ) pq.push(T(a[i].first+b[j].first,a[i].second,b[j].second));
            else {
