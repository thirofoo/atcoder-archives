/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc009/submissions/42181626
 * Submitted at: 2023-06-11 12:32:33
 * Problem URL: https://atcoder.jp/contests/abc009/tasks/abc009_4
 * Result: AC
 * Execution Time: 1343 ms
 */
...
int main() {
    ...
    Matrix ans = matrix_multi( matrix_pow(A, m-1, 1e16), a, 1e16 );
    print( ans.back()[0] );
