/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc029/submissions/48867012
 * Submitted at: 2023-12-26 20:23:13
 * Problem URL: https://atcoder.jp/contests/ahc029/tasks/ahc029_b
 * Result: AC
...
struct State{
    ...
    inline int selectBuyCard(int turn, const vector<Card> &cand_card) {
        ...
        for(int j=0; j<K; j++) {
            ...
            else if( cand_card[j].t == 4 && turn < T - 100 && L < 20 ) {
                // 増資カードが購入可能 ⇒ 最優先で買う
                // ※ ただし最後の 150 ターンは買わない
