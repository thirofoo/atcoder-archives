/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc029/submissions/48841619
 * Submitted at: 2023-12-25 18:33:24
...
struct State{
    ...
    inline void bestWorstUpdate() {
        ...
        sort(sorted_project.begin(), sorted_project.end(), [&](const auto &a, const auto &b) {
            return (a.first.v+pow(2,L)) * b.first.h > (b.first.v+pow(2,L)) * a.first.h;
        });
        return;
    }
