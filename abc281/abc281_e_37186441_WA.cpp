/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc281/submissions/37186441
 * Submitted at: 2022-12-10 23:02:12
...
int main() {
    ...
    print(fw1.sum(0,l)+(k-fw2.sum(0,l))*c[fw2.sum(0,l)]);
    ...
    rep(i,n-m){
        ...
        print(fw1.sum(0,left)+(k-fw2.sum(0,left))*c[fw2.sum(0,left)]);
    }
