/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc281/submissions/37182322
 * Submitted at: 2022-12-10 22:36:39
...
int main() {
    ...
    print(fw1.sum(0,itr)+(k-fw2.sum(0,itr))*c[fw2.sum(0,itr)+1]);
