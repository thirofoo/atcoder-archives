/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc360/submissions/55104052
 * Submitted at: 2024-07-01 01:06:22
...
int main() {
    ...
    rep(i, n) {
        ...
        kukan_l[l[i]+1].emplace_back(i);
        kukan_r[r[i]+1].emplace_back(i);
    }
