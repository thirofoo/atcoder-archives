/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc309/submissions/43385170
 * Submitted at: 2023-07-08 22:28:43
...
int main() {
    ...
    rep(i,n){
        auto [h,w,d] = tyoku[i];
        if( pre != h && sg.prod(w+1,600005) > d ){
            f = true;
            break;
        }
        sg.set(w,max(sg.get(w),d));
        pre = h;
    }
    print( (f ? "Yes" : "No") );
