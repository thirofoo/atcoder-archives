/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc308/submissions/43164043
 * Submitted at: 2023-07-02 02:26:13
 * Problem URL: https://atcoder.jp/contests/abc308/tasks/abc308_g
 * Result: RE
 * Execution Time: 1239 ms
 */
...
int main() {
    ...
    while(q--){
        ...
        if( t == 1 ){
            ...
            auto itr2 = itr1;
            itr2--;
            if(itr1 != st.begin() && itr1 != st.end()){
                cand1 = (*itr1)^(*itr2);
                f1 = true;
            }
            itr2 = itr1;
            itr2++;
            if(itr1 != st.end() && itr2 != st.end()){
                cand2 = (*itr1)^(*itr2);
                f2 = true;
                if(itr1 != st.begin()){
                    itr1--;
