/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc274/submissions/35896238
 * Submitted at: 2022-10-22 22:37:45
 * Problem URL: https://atcoder.jp/contests/abc274/tasks/abc274_e
 * Result: TLE
 * Execution Time: 2267 ms
 */
...
int main() {
    ...
    while(!todo.empty()){
        ...
        rep(i,n+m){
            ...
            todo.push(T( x|(1LL << i), i, c+score, v*(i >= n ? 2 : 1) ));
        }
        f = false;
    }
