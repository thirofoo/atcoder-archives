/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc011/submissions/61493030
 * Submitted at: 2025-01-09 16:00:37
...
int main() {
  ...
  ll op_x = abs(x / d), op_y = abs(y / d);
  ll op_rest = n - op_x - op_y;
