/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc053/submissions/69283559
 * Submitted at: 2025-09-13 22:34:55
...
int main(){
  ...
  long double T0 = max<long double>(1e4L, (long double)max(1LL, medA)*2.0L);
  long double T1 = 1e1L;
