/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc061/submissions/73544769
 * Submitted at: 2026-02-22 23:18:52
...
struct Solver {
  ...
  double evaluate(const State& st) const {
    ...
    double r = s0d / sad;
    constexpr double kEvalScale = 1e5;
    if(r >= 1.0) {
      return kEvalScale * (1.0 - log2(1.0 + 1.0 / r));
    }
    return kEvalScale * (log2(1.0 + r) - 1.0);
  }
