/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc061/submissions/73398431
 * Submitted at: 2026-02-18 13:20:43
 * Problem URL: https://atcoder.jp/contests/ahc061/tasks/ahc061_a
 * Result: AC
 * Execution Time: 1900 ms
 */
...
static constexpr Params PARAMS_BY_M[9] = {
  ...
  /* M=0 */ {20,  9, 15, 0.15, 0.10, 0.00, 0.65, 0.10, 0.70, 500.0},
  /* M=1 */ {20,  9, 15, 0.15, 0.10, 0.00, 0.65, 0.10, 0.70, 500.0},
  /* M=2 */ {20,  9, 15, 0.15, 0.10, 0.00, 0.65, 0.10, 0.70, 500.0},
  /* M=3 */ {20,  9, 15, 0.15, 0.10, 0.00, 0.65, 0.10, 0.70, 500.0},
  /* M=4 */ {20,  9, 15, 0.15, 0.10, 0.00, 0.65, 0.10, 0.70, 500.0},
  /* M=5 */ {20,  9, 15, 0.15, 0.10, 0.00, 0.65, 0.10, 0.70, 500.0},
  /* M=6 */ {20,  9, 15, 0.15, 0.10, 0.00, 0.65, 0.10, 0.70, 500.0},
  /* M=7 */ {20,  9, 15, 0.15, 0.10, 0.00, 0.65, 0.10, 0.70, 500.0},
  /* M=8 */ {20,  9, 15, 0.15, 0.10, 0.00, 0.65, 0.10, 0.70, 500.0}
};
...
struct Solver {
  ...
  double evaluate(const State& st) const {
    ...
    double threat_temp = max(1.0, params.eval_threat_temp);
    double max_sa = -1e100;
    for(int p = 1; p < M; p++) {
    ...
    double lse_sum = 0.0;
    for(int p = 1; p < M; p++) {
      double z = (max(1.0, (double) st.score_p[p] + w * potential[p]) - max_sa) / threat_temp;
      lse_sum += exp(max(-60.0, z));
    }
