/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc294/submissions/40545349
 * Submitted at: 2023-04-11 23:33:29
...
class HLD{
    public:
        HLD() : n(0){}
        explicit HLD(const int _n, bool _vf){
            n = _n;
            vf = _vf;
        ...
        long long query(int u, int v){
            ...
            if(vf || hld[u] != hld[v])res += sg.prod(hld[u], hld[v]+1);
            return res;
        }
