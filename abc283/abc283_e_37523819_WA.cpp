/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc283/submissions/37523819
 * Submitted at: 2022-12-24 23:08:03
...
int main() {
    ...
    ll ans = LLONG_MAX;
    if(dp[h-1][0] != -1)ans = min(ans,dp[h-1][0]);
    if(dp[h-1][1] != -1)ans = min(ans,dp[h-1][1]);
