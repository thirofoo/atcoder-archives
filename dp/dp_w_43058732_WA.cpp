/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/dp/submissions/43058732
 * Submitted at: 2023-06-30 13:44:19
...
int main() {
    ...
    rep(i,n){
        ...
        sort(section[i].begin(), section[i].end(), [](P& e1, P& e2){
            return e1.second > e2.second;
        });

        // 新たに加わる区間を考慮
        dp.set(i,dp.prod(0,i) + cost_sum[i]);
