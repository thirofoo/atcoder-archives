/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/dp/submissions/43072866
 * Submitted at: 2023-07-01 02:38:34
...
int main() {
    ...
    rep(i,n){
        ...
        rep(j,10005){
            ...
            ll resist_w = (j > 10000 ? s : min(j-w,s));
            if( resist_w >= 0 ){
                dp[i+1][resist_w] = max(dp[i+1][resist_w],dp[i][j]+v);
            }
        }
    }
