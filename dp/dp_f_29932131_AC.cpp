/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/dp/submissions/29932131
 * Submitted at: 2022-03-07 12:49:51
...
int main() {
    ...
    while(s_size && t_size){
        ...
        else if(dp[s_size-1][t_size] == dp[s_size][t_size])s_size--;
        else if(dp[s_size][t_size-1] == dp[s_size][t_size])t_size--;
    }
