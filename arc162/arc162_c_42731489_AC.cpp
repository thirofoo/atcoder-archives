/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/arc162/submissions/42731489
 * Submitted at: 2023-06-19 01:32:51
    ...
    while(t--){
        ...
        rep(i,n){
            ...
            while(!todo.empty()){
                ...
                visited[now] = true;
                if(a[now] != -1)cand.push_back(a[now]);
                else empty_cnt++;
            ...
            if(k_exist)continue;
            ans |= (cnt == k && empty_cnt <= 1);
            ans |= (cnt == k-1 && empty_cnt == 1);
            if(ans)break;
        }
        print( (ans ? "Alice" : "Bob") );
    }
