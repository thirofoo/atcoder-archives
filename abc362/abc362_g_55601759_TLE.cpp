/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc362/submissions/55601759
 * Submitted at: 2024-07-14 15:46:25
...
int main() {
  ...
  auto check = [&](ll idx, string &t) {
    string substr = s.substr(sa[idx], min(sa[idx] + t.size(), s.size()));
    return (substr < t);
  };
