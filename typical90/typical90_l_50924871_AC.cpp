/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/typical90/submissions/50924871
 * Submitted at: 2024-03-05 19:04:33
...
int main() {
    ...
    while( q-- ) {
        ...
        if( t == 1 ) {
            ...
            ra--; ca--; rb--; cb--;
            cout << ( red[ra][ca] && red[rb][cb] && uf.same(ra*w+ca, rb*w+cb) ? "Yes" : "No" ) << endl;
        }
        // rep(i,h) {
