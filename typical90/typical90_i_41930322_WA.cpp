/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/typical90/submissions/41930322
 * Submitted at: 2023-06-03 18:26:37
 * Problem URL: https://atcoder.jp/contests/typical90/tasks/typical90_i
 * Result: WA
 * Execution Time: 1856 ms
 */
    ...
    rep(i,n){
        ...
        for(auto &&a:angle){
            ...
            if(itr == angle.begin() || itr == angle.end()){
                ...
                cand = max(cand,min(c1, 360-c1));
                cand = max(cand,min(c2, 360-c2));
            }
            else{
