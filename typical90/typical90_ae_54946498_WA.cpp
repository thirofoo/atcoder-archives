/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/typical90/submissions/54946498
 * Submitted at: 2024-06-26 18:29:42
...
int main() {
    ...
    auto f = [&](auto self, ll white, ll blue) -> ll {
        if(memo[blue*50+white] != -1) return memo[blue*50+white];
        vector<ll> nums;
        if(white > 0) {
            // white 削除遷移
