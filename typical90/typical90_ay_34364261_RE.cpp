/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/typical90/submissions/34364261
 * Submitted at: 2022-08-27 19:10:59
...
int main() {
    ...
    vector<ll> a(n);
    rep(i,n)cin >> a[i];
    vector<vector<ll>> num1(k+1),num2(k+1);
