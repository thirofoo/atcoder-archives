/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/typical90/submissions/34160758
 * Submitted at: 2022-08-20 19:14:21
...
int main() {
    ...
    while(n--){
        int l,r,v; cin >> l >> r; l--;
        //prod ：(l,r]のdataにおいてopを作用させてdata取得
        v = sg.prod(l,r)+1;
        //apply：(l,r]のlazyをvを用いて更新させる
        sg.apply(l,r,v);
        cout << v << endl;
    }
