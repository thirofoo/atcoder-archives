/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/typical90/submissions/28462241
 * Submitted at: 2022-01-11 16:27:33
...
int main() {
    ...
    rep(i,q){
        ...
        else if(*itr == classes[n-1]) ans.push_back(abs(a-classes[n-1]));
