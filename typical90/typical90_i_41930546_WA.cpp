/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/typical90/submissions/41930546
 * Submitted at: 2023-06-03 18:35:04
 * Problem URL: https://atcoder.jp/contests/typical90/tasks/typical90_i
 * Result: WA
 * Execution Time: 1576 ms
 */
...
int main() {
    ...
    rep(i,n){
        ...
        for(auto a:angle){
            ...
            auto itr = lower_bound(angle.begin(),angle.end(),ideal);
