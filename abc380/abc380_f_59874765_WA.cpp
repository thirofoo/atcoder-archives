/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc380/submissions/59874765
 * Submitted at: 2024-11-16 22:35:03
...
int main() {
  ...
  auto dfs = [&](auto self, ll aoki, ll takahashi, ll p, ll turn) -> ll {
    ...
    ll res = (turn % 2 == 0);
    if(turn % 2 == 0) {
      if(takahashi == 0) return grundy[{aoki, takahashi, p}] = 0;
      ...
      if(aoki == 0) return grundy[{aoki, takahashi, p}] = 1;
