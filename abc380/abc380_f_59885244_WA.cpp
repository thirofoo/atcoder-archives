/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc380/submissions/59885244
 * Submitted at: 2024-11-17 00:46:00
...
int main() {
  ...
  auto dfs = [&](auto self, ll aoki, ll takahashi, ll p, ll turn) -> bool {
    ...
    if(turn % 2 == 0) {
      rep(i, total) {
        ...
        if(!self(self, aoki, ntakahashi, np, turn + 1)) {
          return dp[{aoki, takahashi, p}] = true;
        }
        rep(j, total) {
    ...
    return dp[{aoki, takahashi, p}] = false;
  };
