/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc020/submissions/42225118
 * Submitted at: 2023-06-13 02:31:51
    ...
    void solve(){
        ...
        while(utility::mytm.elapsed() <= TIME_LIMIT){
            ...
            if(query == 0){
                ...
                ll alter = Graph[place][rand_int()%Graph[place].size()];
                ...
                // power調整 part
                place = rand_int()%n;
                ele_power = min(5000ll, max(0ll, power[place] + 100 - (rand_int()%400 + 1)));
