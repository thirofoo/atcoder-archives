/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc020/submissions/42193177
 * Submitted at: 2023-06-11 18:06:03
 * Problem URL: https://atcoder.jp/contests/ahc020/tasks/ahc020_a
 * Result: AC
 * Execution Time: 1811 ms
 */
...
inline double temp(int start) {
    double start_temp = 3,end_temp = 0.1;
...
struct Solver{
    ...
    void solve(){
        ...
        while(utility::mytm.elapsed() <= TIME_LIMIT){
            ...
            if(rnd_d < temp){
                if(temp < 1){
                    cerr << best_score << " " << cand_score << endl;
