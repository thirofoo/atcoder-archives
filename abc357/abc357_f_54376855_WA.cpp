/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc357/submissions/54376855
 * Submitted at: 2024-06-08 22:38:26
...
S mapping(F f,S x) {
    ...
    res.ans_sum = x.ans_sum + b*x.a_sum + a*x.b_sum + x.size*a*b*x.size;
    res.size = x.size;
    return res;
}
// 遅延データ作用 ※ f(g(x))
