/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc014/submissions/35269915
 * Submitted at: 2022-10-01 20:14:25
...
inline bool createRect(int x1,int y1){
    rep(i,8){
        ...
        todo.emplace(T3(Graph[x1][y1][reverseDir(i+1)]+Graph[x1][y1][nextDir(reverseDir(i+1))],T(x1,y1,x2,y2,x4,y4,x3,y3,i)));
    }
