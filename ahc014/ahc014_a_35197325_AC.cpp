/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc014/submissions/35197325
 * Submitted at: 2022-09-27 19:57:57
...
inline void query4(){
    ...
    rep(j,info.second.size()){
        ...
        rep(i,8){
            ...
            todo2.emplace(T3(score(x4,y4),T(nx1,ny1,x2,y2,x4,y4,x3,y3,i)));
        }
