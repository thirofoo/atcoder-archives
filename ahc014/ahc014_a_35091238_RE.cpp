/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc014/submissions/35091238
 * Submitted at: 2022-09-24 20:48:47
 * Problem URL: https://atcoder.jp/contests/ahc014/tasks/ahc014_a
 * Result: RE
 * Execution Time: 4966 ms
 */
...
void solve(){
    ...
    while((now = utility::mytm.elapsed()) <= TIME_LIMIT){
        ...
        rnd1 = randInt()%10000;
        if(rnd1 > 1050)query1();
        else if(rnd1 > 1000)query2();
        else if(rnd1 > 10)query3();
        else if(rnd1 > 0)query4();
        else query5();
    }
    cand.push_back(info);
