/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc014/submissions/34962880
 * Submitted at: 2022-09-18 09:39:35
...
ll n,m,turn = 0,x2,y2,x3,y3,x4,y4,lx,ly,nd,rd,nrd,start,now;
...
bool createRect(ll x1,ll y1){
    ...
    double r = prob(n*n/32+1,s,start);
    // cerr << s << " " << r << " " << start << endl;
    if(r < 1 && r < randDouble() && !cand[turn].second.empty()){
