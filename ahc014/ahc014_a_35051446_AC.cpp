/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc014/submissions/35051446
 * Submitted at: 2022-09-22 23:44:07
...
int n,m,turn = 0,x2,y2,x3,y3,x4,y4,lx,ly,nd,rd,nrd,start,total,tmp,tmp1,tmp2,tmp3,tx,ty,tx2,ty2,tx3,ty3,rnd1,rnd2,sum = 0;
...
void eraseRect(){
    ...
    rep(i,8){
        if(Graph[nx2][ny2][i])tmp++;
        if(Graph[nx3][ny3][i])tmp++;
        if(Graph[nx4][ny4][i])tmp++;
    }
