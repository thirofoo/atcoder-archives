/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc014/submissions/35194690
 * Submitted at: 2022-09-27 17:07:11
 * Problem URL: https://atcoder.jp/contests/ahc014/tasks/ahc014_a
 * Result: AC
 * Execution Time: 4925 ms
 */
...
inline void query4(){
    rep(j,info.second.size()){
        ...
        rep(i,8){
            ...
            todo2.emplace(T3(abs(nx1-x4)+abs(ny1-y4)+abs(x2-x3)+abs(y2-y3),T(nx1,ny1,x2,y2,x4,y4,x3,y3,i)));
        }
