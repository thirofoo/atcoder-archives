/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc014/submissions/35210647
 * Submitted at: 2022-09-28 15:29:01
...
inline bool createRect(int x1,int y1){
    rep(i,8){
        ...
        todo.emplace(T3(abs(x1-x4)+abs(y1-y4)+abs(x2-x3)+abs(y2-y3),T(x1,y1,x2,y2,x4,y4,x3,y3,i)));
    }
...
inline void query4(){
    ...
    rep(j,info.second.size()){
        ...
        rep(i,8){
            ...
            todo.emplace(T3(score(x4,y4),T(nx1,ny1,x2,y2,x4,y4,x3,y3,i)));
        }
