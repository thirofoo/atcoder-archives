/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc014/submissions/35157261
 * Submitted at: 2022-09-25 16:51:15
...
int n,m,turn = 0,x2,y2,x3,y3,x4,y4,lx,ly,nd,rd,nrd,start,total,tmp,tmp1,tmp2,tmp3,tx,ty,tx1,ty1,tx2,ty2,tx3,ty3,rnd1,rnd2,sum = 0,vnum,update = 0;
