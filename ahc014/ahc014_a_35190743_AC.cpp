/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc014/submissions/35190743
 * Submitted at: 2022-09-27 12:19:45
 * Problem URL: https://atcoder.jp/contests/ahc014/tasks/ahc014_a
 * Result: AC
 * Execution Time: 4940 ms
 */
...
int n,m,turn = 0,x2,y2,x3,y3,x4,y4,lx,ly,nd,rd,nrd,start,total,tmp,tmp1,tmp2,tmp3,tx,ty,tx1,ty1,tx2,ty2,tx3,ty3,rnd1,rnd2,sum = 0,vnum,update = 0,lim;
double r,preScore,nowScore,bestScore,now,pena;
T2 info,bestInfo;
queue<P> que;
vector<T2> cand;
