/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc014/submissions/35050806
 * Submitted at: 2022-09-22 23:10:13
 * Problem URL: https://atcoder.jp/contests/ahc014/tasks/ahc014_a
 * Result: AC
 * Execution Time: 4923 ms
 */
...
int n,m,turn = 0,x2,y2,x3,y3,x4,y4,lx,ly,nd,rd,nrd,start,total,tmp,tx,ty,tx2,ty2,tx3,ty3,rnd1,rnd2,sum = 0,TIME;
