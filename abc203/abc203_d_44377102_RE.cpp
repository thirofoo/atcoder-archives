/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc203/submissions/44377102
 * Submitted at: 2023-08-08 11:45:44
...
int main() {
    ...
    auto adjust = [&]() -> void {
        while(st1.empty() || st1.size() < st2.size() || (!st2.empty() && (*st1.rbegin()) > (*st2.begin()))) {
