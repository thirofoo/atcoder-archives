/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc002/submissions/55828580
 * Submitted at: 2024-07-21 03:07:36
...
struct Solver{
    ...
    void solve() {
        ...
        while( utility::mytm.elapsed() < TIME_LIMIT ) {
            ...
            r = min( l + (int)rand_int() % 10 + 10, (int)ans_point.size()-1); // End 以外
