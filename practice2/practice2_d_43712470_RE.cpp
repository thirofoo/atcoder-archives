/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/practice2/submissions/43712470
 * Submitted at: 2023-07-18 12:09:14
...
int main() {
    ...
    rep(i,n){
        rep(j,n){
            ...
            // start , goal を結ぶ辺を追加
            if( idx(i,j)%2 == 1 ) Graph[start].push_back( pair<int, long long>(idx(i,j), 1) );
