/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc239/submissions/29487635
 * Submitted at: 2022-02-20 10:30:16
...
void dfs(int n){
    ...
    for(auto k:edge[n]){
        ...
        vector<int> a;
        dfs(k);
        merge(top[n].begin(),top[n].end(),top[k].begin(),top[k].end(),back_inserter(a));
        top[n] = a;
    }
