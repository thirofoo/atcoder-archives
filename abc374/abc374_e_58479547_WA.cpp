/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc374/submissions/58479547
 * Submitted at: 2024-10-05 22:24:54
...
int main() {
  ...
  while(r1 - l1 > 1) {
    ...
    rep(i, n) {
      ...
      while(true) {
        cand2 = min(cand2, a_num * p[i] + max((rest - a_num * a[i] + b[i] - 1), 0LL) / b[i] * q[i]);
