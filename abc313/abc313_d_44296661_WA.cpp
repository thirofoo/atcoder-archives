/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc313/submissions/44296661
 * Submitted at: 2023-08-05 22:13:55
...
int main() {
    ...
    for(ll i=1;i<k;i++) cout << " " << p[i].second + 1;
    cout << endl << flush;
    cin >> res2;
    
    if( res1 == res2 ) {
        if( uf.same(0,p.back().second) ) {
            cout << "!";
