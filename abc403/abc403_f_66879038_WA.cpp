/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc403/submissions/66879038
 * Submitted at: 2025-06-19 16:03:01
...
int main() {
  ...
  cout << (dp[n][0] == "" || dp[n][0].size() < dp[n][1].size() ? dp[n][0] : dp[n][1]) << endl;
