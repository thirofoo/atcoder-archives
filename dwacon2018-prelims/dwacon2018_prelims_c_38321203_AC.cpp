/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/dwacon2018-prelims/submissions/38321203
 * Submitted at: 2023-01-25 21:56:07
...
int main() {
    ...
    // 前計算で分割数を求める
    // dp[i][j] : j の i 分割数 
    vector<vector<mint>> dp_div(1005,vector<mint>(1005,0));
    rep(i,1005)dp_div[1][i] = 1;
    for(ll i=2;i<1005;i++){
        rep(j,1005){
