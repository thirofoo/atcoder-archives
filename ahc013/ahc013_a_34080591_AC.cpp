/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc013/submissions/34080591
 * Submitted at: 2022-08-16 12:25:14
...
//k == 5の時の温度は良くわからん。
vector<double> validScore = {0, 0, 130,  50,    30,   INFINITY};
vector<double> startTemp =  {0, 0, 10,   5,     4,    INFINITY};
vector<double> endTemp =    {0, 0, 0.05, 0.05,  0.01, INFINITY};
