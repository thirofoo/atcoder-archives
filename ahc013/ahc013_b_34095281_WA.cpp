/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc013/submissions/34095281
 * Submitted at: 2022-08-16 19:50:14
 * Problem URL: https://atcoder.jp/contests/ahc013/tasks/ahc013_b
 * Result: WA
 * Execution Time: 2998 ms
 */
...
int n,k,K,moveSize = 0,bestScore = 0,nowScore,turn = 0,sTime,nowTime,nm,dr,eleBase = 10;
bool moveF;
//Graph：隣接行列で表現
...
inline int calcScore(){
    ...
    rep(i,n){
        rep(j,n){
            ...
            //大きさがeleBase以下のグルはスコアが低いから考慮しない
