/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc013/submissions/33960704
 * Submitted at: 2022-08-12 19:16:29
...
//swap回数を決める関数
vector<int> validTime1 = {0,0,1000,1000,1000,1000};
vector<int> validTime2 = {0,0,300,300,300,500};
int swapNum(int t,int k){
    if(k == 5){
        return min((t-validTime1[k])/validTime2[k],8);
    }

    if(t <= validTime1[k])return 0;
    else return (t-validTime1[k])/validTime2[k];
}
