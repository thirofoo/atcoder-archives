/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc013/submissions/33971772
 * Submitted at: 2022-08-13 10:35:38
 * Problem URL: https://atcoder.jp/contests/ahc013/tasks/ahc013_a
 * Result: AC
 * Execution Time: 2990 ms
 */
...
void solve(){
    ...
    while(cnt%500 || (nowTime = utility::mytm.elapsed()) <= TIME_LIMIT){
        cnt++;

        if(movement.size()+cand.back().size() >= k){
