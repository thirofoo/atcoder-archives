/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc013/submissions/34061444
 * Submitted at: 2022-08-15 14:40:45
...
int n,k,K,moveSize = 0,bestScore = 0,cnt = 0,sTime,nowTime,nm,dr,eleBase = 30;
bool moveF;
//Graph：隣接行列で表現
