/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc008/submissions/29369007
 * Submitted at: 2022-02-16 18:53:26
...
string people_do(){
    ...
    rep(i,m){
        ...
        if(go[i/2] && ((n <= 14 && pet_cnt[cnt-1][x/3]) || (n > 14 && ((pet_cnt[cnt-1][x/3] >= 2 && cnt <= 220) || (pet_cnt[cnt-1][x/3] >= 1 && cnt <= 300)))) && (field[x][y-1] == 0 || field[x][y+1] == 0) && (x%3 == 0 || x == 1)){
            if(i%2 == 0){ action = 'l';}
            else { action = 'r';}
        }
