/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc008/submissions/29495215
 * Submitted at: 2022-02-20 16:15:59
            ...
            if(!(field[1][1] >= 10 || field[2][1] >= 10 || field[3][1] >= 10 || field[1][30] >= 10 || field[2][30] >= 10 || field[3][30] >= 10 || field[1][2] || field[1][29])){
                ...
                rep(j,m){
                    ...
                    switch(j){
                        ...
                        case 3:player_action[j].insert(cnt+17+(30/m)*1,go01); break;
                        case 4:player_action[j].insert(cnt+17+(30/m)*2,go01); break;
                        case 5:player_action[j].insert(cnt+17+(30/m)*2,go01); break;
                        case 6:player_action[j].insert(cnt+17+(30/m)*3,go01); break; 
                        case 7:player_action[j].insert(cnt+17+(30/m)*3,go01); break;
                        case 8:player_action[j].insert(cnt+17+(30/m)*4,go01); break;
                        case 9:player_action[j].insert(cnt+17+(30/m)*5,go01); break;
                    }
                }
                F = false;
                letgo = cnt+16;  
