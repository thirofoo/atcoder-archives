/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc008/submissions/29300502
 * Submitted at: 2022-02-13 20:52:36
...
void people_action_deciding(){
    rep(i,m){
        ...
        if(i == 0 || i == 1){
            ...
            while(tmp.size() <= 290)tmp += move_up;
