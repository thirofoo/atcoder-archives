/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc008/submissions/29615941
 * Submitted at: 2022-02-24 12:45:32
...
//横一列並べ用の移動文字列
string pdo0 = "rDrDrDrDrDrDrDrDrDrDrDrDrDrDuDrDruDrDrDrDrDrDrDrDrDrDrDrDrLlUlUlUlUlUlUlUlUlUlUlUlUlUlUUlUlUlUlUlUlUlUlUlUlUlUlUlUlUd";
string pdo = "rDrDrDrDrDrDrDrDrDrDrDrDrDrDuDrDruDrDrDrDrDrDrDrDrDrDrDrDrLlUlUlUlUlUlUlUlUlUlUlUlUlULlUdUlRlUlUlUlUlUlUlUlUlUlUlUlUlUlUd";
...
string going5 = "LLLLLLLLLLLLLLLLLLLLLLLLLLLLRRRRRRRRRRRRRRRRRRRRRRRRRRRRLLLLLLLLLLLLLLLLLLLLLLLLLLLLRRRRRRRRRRRRRRRRRRRRRRRRRRRRLLLLLLLLLLLLLLLLLLLLLLLLLLLLRRRRRRRRRRRRRRRRRRRRRRRRRRRR";
...
void people_action_deciding(){
    rep(i,m){
        ...
        if(i <= 4){
            ...
            else if(y%6 == 1){tmp += "R"; left_cnt--;}
            else if(y%6 == 0){tmp += "LL"; left_cnt += 2;}
            rep(i,x)tmp += "U";
            ...
            rep(i,x)tmp += "U";
            if(i%2 == 0)rep(i,y-left_cnt)tmp += "L";
            else rep(i,30-(y-left_cnt))tmp += "R";
...
string people_do(){
    ...
    rep(i,m){
        ...
        //上で犬待ちすぎ防止
        if(150 <= cnt && cnt <= 190 && x == 1)wait_frag[i] = false;
        if(wait_frag[i] && x == 1 && (y != 1 && y != 30) && cnt >= 190){
            player_action[i].insert(cnt+1,(i == 0 || i == 1 ? "RdRRdRdLLLLLLLLLLLLLLLLLL" : "RdRRdRdRRRRRRRRRRRRRRR"));
            wait_frag[i] = false;
        }
        ...
        if(frag && F){
            if(cnt >= 231 || (!(field[1][1] >= 10 || field[2][1] >= 10 || field[3][1] >= 10 || field[1][30] >= 10 || field[2][30] >= 10 || field[3][30] >= 10 || field[1][2] || field[1][29]) && cnt >= 205)){
                frag2 = true;
                rep(j,m){
                    ...
                    if(j >= 5 && j%2 == 0)player_action[j].insert(cnt+17,"RRRRRRRRRRRRRRRRRRRRRRRRRRRR"+going5);
                    else if(j >= 5 && j%2 == 1)player_action[j].insert(cnt+17,going5);
                }
                F = false;
                letgo = cnt+16;  
            }
