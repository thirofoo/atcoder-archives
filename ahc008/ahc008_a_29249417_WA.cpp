/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc008/submissions/29249417
 * Submitted at: 2022-02-13 10:14:52
...
string per_todo(){
    ...
    rep(i,m){
        int dx = 0,dy = 0;
        char action = pdo[(cnt-time_dif*i)%pdo.size()];
        ...
        auto [x,y] = people[i];
        //操作先が柵だった時。
        if(field[x+dx][y+dy] == -2){todo += '.'; continue;}
