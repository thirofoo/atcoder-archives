/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc008/submissions/29371918
 * Submitted at: 2022-02-16 21:34:15
...
string people_do(){
    ...
    rep(i,m){
        ...
        if(go[i] && pet_cnt[cnt-1][x/3] && (field[x][y-1] == 0 || field[x][y+1] == 0) && (x%3 == 0 || x == 1)){
            if(i%2 == 0){ action = 'l';}
            else { action = 'r';}
        }
