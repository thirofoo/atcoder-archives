/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc008/submissions/29413059
 * Submitted at: 2022-02-19 10:27:12
...
//横一列並べ用の移動文字列
string p1do = "RuRlRldRRlRlRldRRlRlRldRRlRlRlRlRlRldRRlRlRldRRlRlRldRRulDuDDuLrLrdLLrLrLrdLLrLrLrdLLrLrLrLrLrLrdLrLrLrLrdLLrLrLrdLLruLr";
string p50do = "LuLrLrdLLrLrLrdLLrLrLrdLLrLrLrLrLrLrdLLrLrLrdLLrLrLrdLLruDuDDuRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRulRl";
string p2do = "LuLrLrdLLrLrLrdLLrLrLrdLLrLrLrLrLrLrdLLrLrLrdLLrLrLrdLLruDuDDuRlRldRRlRlRldRRlRlRldRRlRlRlRlRlRldRRlRlRldRRlRlRldRRulRl";
string p10do = "LLrLrdLLrLrLrdLLrLrLrdLLrLrLrLrLrLrdLLrLrLrdLLrLrLrdLLrDuDDuRlRldRRlRlRldRRlRlRldRRlRlRlRlRlRldRRlRlRldRRlRlRldRRulRl";
...
string go01_2 = "DDDDDDDDDDDDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUUUUUUUUUUDDDDDDDDDDDDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUUUUUUUUUUDDDDDDDDDDDDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUUUUUUUUUU";
string go23_2 = "UUUUUUUUUUUUUUUUUUUUUUUUUUUUUDDDDDDDDDDDDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUUUUUUUUUUDDDDDDDDDDDDDDDDDDDDDDDDDDDDDUUUUUUUUUUUUUUUUUUUUUUUUUUUUUDDDDDDDDDDDDDDDDDDDDDDDDDDDDD";
        ...
        if(dog_cnt >= dog_base){
            ...
            if(frag && F){
                rep(i,m){
                    ...
                    else if(i == 2 || i == 3)player_action[i].insert(cnt+6,go23);
                    else if((i == 4 || i == 5) && m >= 6)player_action[i].insert(cnt+6,go01);
                    else if((i == 6 || i == 7) && m >= 8)player_action[i].insert(cnt+6,go23);
                    else if((i == 8 || i == 9) && m >= 10)player_action[i].insert(cnt+6,go01);
                }
                F = false;
            }
        }
            ...
            if(cnt >= 150 && player_action[0][cnt] == '.' && player_action[1][cnt] == '.'){
                player_action[0].insert(cnt+1,go01_2);
                player_action[1].insert(cnt+1,go01_2);
                go[0] = true;
            }
            if(cnt >= 150 && player_action[2][cnt] == '.' && player_action[3][cnt] == '.'){
                player_action[2].insert(cnt+1,go23_2);
                player_action[3].insert(cnt+1,go23_2);
                go[1] = true;
            }
        }

        if((!F || go[i/2]) && (dog_cnt < dog_base || ((x != 15 && dog_cnt >= dog_base))) && ((((pet_cnt[cnt-1][x/3] >= 2 && cnt >= 150) || (pet_cnt[cnt-1][x/3] >= 1 && cnt >= 240)) && dog_cnt < dog_base) || (((pet_cnt[cnt-1][x/3] >= 2 && cnt >= 210) || (pet_cnt[cnt-1][x/3] >= 1 && cnt >= 260)) && dog_cnt >= dog_base)) && (field[x][y-1] == 0 || field[x][y+1] == 0)){
