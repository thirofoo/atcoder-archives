/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc008/submissions/29409062
 * Submitted at: 2022-02-19 00:43:51
...
vector<T> pet;
vector<P> people;
int n,m,cnt,last_cnt = 1,dog_cnt = 0;
...
string people_do(){
    ...
    rep(i,m){
        ...
        if((!F || go[i/2]) && x != 15 && ((pet_cnt[cnt-1][x/3] >= 3 && cnt <= 210) || (pet_cnt[cnt-1][x/3] >= 2 && cnt <= 240) || (pet_cnt[cnt-1][x/3] >= 1 && cnt <= 300)) && (field[x][y-1] == 0 || field[x][y+1] == 0)){
