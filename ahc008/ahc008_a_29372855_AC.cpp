/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc008/submissions/29372855
 * Submitted at: 2022-02-16 22:13:00
...
//横一列並べ用の移動文字列
string p1do = "RuRRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRulRDDDLuLLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLruL";
string p2do = "LuLLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLurLDDDRuRRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRulR";
string p10do = "LLLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLDDDRuRRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRulR";
...
void people_action_deciding(){
    rep(i,m){
        ...
        else if(i%5 == 2 || i%5 == 4) tmp += p2do;
        else tmp += p10do;

        if(i%5 == 0)tmp += "UUUU";
        else if(i%5 == 1)tmp += "UUUUUUUUUU";
        else if(i%5 == 2)tmp += "DDDDDDDDDDDDD";
        else if(i%5 == 3)tmp += "DDDDDDD";
        else if(i%5 == 4)tmp += "D";
...
string people_do(){
    ...
    rep(i,m){
        ...
        if((i == 0 || i == 1 || i == 4 || i == 5 || i == 8 || i == 9) && cnt >= 150 && player_action[i][cnt] == '.'){
            player_action[i].insert(cnt+1,go01);
            go[i] = true;
        }
        if((i == 2 || i == 3 || i == 6 || i == 7) && cnt >= 150 && player_action[i][cnt] == '.'){
            player_action[i].insert(cnt+1,go23);
            go[i] = true;
        }

        if(go[i] && pet_cnt[cnt-1][x/3] && ((pet_cnt[cnt-1][x/3] >= 2 && cnt >= 150) || (pet_cnt[cnt-1][x/3] >= 1 && cnt >= 200)) && (field[x][y-1] == 0 || field[x][y+1] == 0) && (x%3 == 0 || x == 1)){
            if(i%2 == 0){ action = 'l';}
            else { action = 'r';}
        }
