/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc008/submissions/29398040
 * Submitted at: 2022-02-18 12:30:45
...
//横一列並べ用の移動文字列
string p1do = "RudRldRdRdRdRdRdRdRdRdRdRdRdRdRdRdRdRdRdRdRdRdRdRdRdRdRdRuDuDuDLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLrLr";
string p2do = "LudLrdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLuDuDuDRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRl";
string p10do = "LdLrdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLdLDuDuDRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRlRl";
...
string people_do(){
    ...
    rep(i,m){
        ...
        if(go[i/2] && pet_cnt[cnt-1][x/3] && (field[x][y-1] == 0 || field[x][y+1] == 0)){
            if(i%2 == 0){ action = 'l';}
            else { action = 'r';}
        }
