/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc011/submissions/32165434
 * Submitted at: 2022-06-02 23:24:11
 * Problem URL: https://atcoder.jp/contests/ahc011/tasks/ahc011_a
 * Result: WA
 * Execution Time: 2907 ms
 */
...
int main() {
    ...
    while(utility::mytm.elapsed() <= 100*(n-5)){
    ...
    while(utility::mytm.elapsed() <= 2900){
        ...
        if(utility::mytm.elapsed() > 100*(n-5)/sample_num * (cnt+1) && flag){
