/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc011/submissions/32265422
 * Submitted at: 2022-06-05 17:00:29
 * Problem URL: https://atcoder.jp/contests/ahc011/tasks/ahc011_a
 * Result: AC
 * Execution Time: 2925 ms
 */
...
int main() {
    ...
    if(n <= 8){
        ...
        while((time = utility::mytm.elapsed()) <= 2900){
            ...
            int score = round(500000*calc_score(tmp_ok,false)/(n*n-1));
