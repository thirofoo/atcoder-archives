/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc011/submissions/32193278
 * Submitted at: 2022-06-04 17:06:12
...
int calc_score(vector<vector<vector<bool>>>& tmp_ok,bool flag){
    ...
    rep(i,n){
        rep(j,n){
            ...
            if((i == 0 || j == 0) && tmp_ok[i][j][0] && tmp_ok[i][j][1] && tmp_ok[i][j][2] && tmp_ok[i][j][3]){
                return -INT_MAX;
            }
        }
    }
