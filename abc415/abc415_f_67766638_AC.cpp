/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc415/submissions/67766638
 * Submitted at: 2025-07-20 01:08:02
 * Problem URL: https://atcoder.jp/contests/abc415/tasks/abc415_f
 * Result: AC
 * Execution Time: 1866 ms
 */
    ...
    if(t == 1) {
      ...
      if(itr != st.begin()) {
        ...
        if(itr->second <= r) ans = max(ans, sg_l.prod(l, r + 1));
          ...
          ans = max(ans, r - max(l, itr->first) + 1);
        }
      }
