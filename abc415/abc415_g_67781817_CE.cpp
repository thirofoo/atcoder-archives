/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc415/submissions/67781817
 * Submitted at: 2025-07-20 18:41:02
...
int main() {
  ...
  P best = {INF, -INF};
  rep(i, cand.size()) {
    if(best.second * (cand[i].first - cand[i].second) < cand[i].first * (best.first - best.second)) {
      best_val = 
    }
  }
