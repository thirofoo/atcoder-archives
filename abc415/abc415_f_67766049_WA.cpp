/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc415/submissions/67766049
 * Submitted at: 2025-07-20 00:41:54
 * Problem URL: https://atcoder.jp/contests/abc415/tasks/abc415_f
 * Result: WA
 * Execution Time: 1162 ms
 */
  ...
  while(q--) {
    ...
    if(t == 1) {
      ...
      if(itr != st.begin()) {
        ...
        else if(l < itr->first) ans = max(ans, sg_l.prod(l, itr->first));
      }
      cout << ans << endl;
    }
