/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc415/submissions/67768008
 * Submitted at: 2025-07-20 02:46:45
 * Problem URL: https://atcoder.jp/contests/abc415/tasks/abc415_f
 * Result: RE
 * Execution Time: 1346 ms
 */
...
int main() {
  ...
  while(q--) {
    ...
    if(t == 1) {
      ...
      if(tl3 != -1 && tl3 <= r) ans = max(ans, sg_r.prod(tl3, r + 1));
