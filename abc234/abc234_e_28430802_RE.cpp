/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc234/submissions/28430802
 * Submitted at: 2022-01-09 16:07:59
...
int main() {
    ...
    if(x.size() <= 2)cout << x << endl;
        ...
        while(true){
            ...
            if(frag2 && cand2 >= x)ans = min(ans,stoll(cand2));
            a++;
            if(a == 5)break;
        }
        cout << ans << endl;
