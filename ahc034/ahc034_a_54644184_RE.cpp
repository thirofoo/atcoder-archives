/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc034/submissions/54644184
 * Submitted at: 2024-06-16 19:48:53
 * Problem URL: https://atcoder.jp/contests/ahc034/tasks/ahc034_a
 * Result: RE
 * Execution Time: 1038 ms
 */
        ...
        while(border >= 0) {
            ...
            if(field[x][y] > 0) {
                ...
                if(abs(field[x][y]) <= this->have) {
                    ...
                    if(outField(x, y)) {
                        miss_dir = dir;
                        dx = dir_char[miss_dir].first;
                        dy = dir_char[miss_dir].second;
                    }
                    x += dx, y += dy;
                    score += 100 + have;
