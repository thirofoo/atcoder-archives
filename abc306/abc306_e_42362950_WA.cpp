/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc306/submissions/42362950
 * Submitted at: 2023-06-17 22:33:59
...
int main() {
    ...
    ll ans = 0;
    ll k_num = 0;
    fenwick_tree<ll> fw1(1000010),fw2(1000010);
    fw1.add(1,n);
    ...
    rep(i,q){
        ...
        ll ans = fw2.sum(left,1000010);
        // print(ans);
        ans -= (fw1.sum(left,1000010) - k) * comp[left];
        print(ans);
    }
