/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc306/submissions/42361432
 * Submitted at: 2023-06-17 22:27:16
 * Problem URL: https://atcoder.jp/contests/abc306/tasks/abc306_e
 * Result: RE
 * Execution Time: 617 ms
 */
...
int main() {
    ...
    ll ans = 0;
    ll k_num = 0;
    fenwick_tree<ll> fw1(2*n+4),fw2(2*n+4);
    fw1.add(1,n);
    ...
    rep(i,q){
        ...
        ll ans = fw2.sum(left,2*n+4);
        // print(ans);
        ans -= (fw1.sum(left,2*n+4) - k) * comp[left];
        print(ans);
    }
