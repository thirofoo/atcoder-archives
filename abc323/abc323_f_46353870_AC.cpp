/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc323/submissions/46353870
 * Submitted at: 2023-10-07 23:03:07
...
int main() {
    ...
    if( (xa < xb && xb < xc && ya < yb && yb < yc) || (xc < xb && xb < xa && ya < yb && yb < yc) || (xa < xb && xb < xc && yc < yb && yb < ya) || (xc < xb && xb < xa && yc < yb && yb < ya) ) {
        cout << abs(xa-xc) + abs(ya-yc) + 1 << endl;
        return 0;
    }
    if( xa == xb && xb == xc ) {
