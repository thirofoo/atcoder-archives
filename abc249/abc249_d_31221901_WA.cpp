/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc249/submissions/31221901
 * Submitted at: 2022-04-24 11:20:03
...
int main() {
    ...
    rep(i,n){
        ...
        rep(j,size){
            int tmp1 = a_num[fact[i][j]]; 
            int tmp2 = a_num[a[i]/fact[i][j]]; 
            ans += tmp1*tmp2;
        }
    }
    cout << ans << endl;
