/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc021/submissions/42963161
 * Submitted at: 2023-06-25 22:15:08
 * Problem URL: https://atcoder.jp/contests/ahc021/tasks/ahc021_a
 * Result: AC
 * Execution Time: 1969 ms
 */
        ...
        rep(i,n*(n+1)/2){
            ...
            while(!todo.empty()){
                ...
                rep(j,4){
                    ...
                    todo.push(T2(cost + n*(n+1)/2 - ball[px1][py1] ,px1,py1,now_x,now_y));
                }
            }
