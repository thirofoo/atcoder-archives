/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc021/submissions/42963394
 * Submitted at: 2023-06-25 22:22:58
        ...
        rep(i,n*(n+1)/2){
            ...
            while(!todo.empty()){
                ...
                rep(j,4){
                    ...
                    todo.push(T2(cost + n*(n+1)/2 - ball[px1][py1] + 1000 ,px1,py1,now_x,now_y));
                }
            }
