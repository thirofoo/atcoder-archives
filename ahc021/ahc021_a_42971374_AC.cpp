/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc021/submissions/42971374
 * Submitted at: 2023-06-26 11:39:42
 * Problem URL: https://atcoder.jp/contests/ahc021/tasks/ahc021_a
 * Result: AC
 * Execution Time: 1971 ms
 */
        ...
        rep(i,n*(n+1)/2){
            ...
            while(!todo.empty()){
                ...
                rep(j,4){
                    ...
                    todo.push(T2(cost + n*(n+1)/2 - ball[px1][py1] + rand_int()%100 + 100 ,px1,py1,now_x,now_y));
                }
            }
            ...
            rep(j,n){
                for(int k=0;k<=j;k++){
                    ...
                    if(visited[j][k] + (k == 0 || k == j ? 250 : 0) < min_cost){
