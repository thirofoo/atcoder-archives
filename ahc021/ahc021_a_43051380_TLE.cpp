/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc021/submissions/43051380
 * Submitted at: 2023-06-29 23:46:05
...
struct Solver{
    ...
    inline void beamSearch(State field){
        // 1つの field から5分岐
        rep(i,5){
            State candidate = field;
            candidate.solve();
