/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc277/submissions/36412648
 * Submitted at: 2022-11-12 21:06:13
...
int main() {
    ...
    rep(i,n){
        ...
        bool f = true;
        rep(i,4)if(s[0] == o[i])f = false;
        rep(i,13)if(s[1] == t[i])f = false;
