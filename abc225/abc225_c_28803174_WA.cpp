/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc225/submissions/28803174
 * Submitted at: 2022-01-26 11:35:58
...
int main() {
    ...
    for(int i=1;i<n;i++)rep(j,m)if(num[i][j] != num[i-1][j]+7)return cout << "No" << endl,0;
    cout << "Yes" << endl;
    return 0;
}