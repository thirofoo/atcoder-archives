/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc246/submissions/30679484
 * Submitted at: 2022-04-03 00:32:31
 * Problem URL: https://atcoder.jp/contests/abc246/tasks/abc246_e
 * Result: AC
 * Execution Time: 1886 ms
 */
    ...
    while(!todo.empty()){
        ...
        rep(i,4){
            ...
            while(0 <= nx && nx < n && 0 <= ny && ny < n && field[nx][ny] != '#'){
                ...
                if(p[bx][by] != INT_MAX)return cout << p[bx][by] << endl,0;
                nx += vx[i];
                ny += vy[i];
            }
        }
