/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc032/submissions/52150626
 * Submitted at: 2024-04-07 21:37:42
 * Problem URL: https://atcoder.jp/contests/ahc032/tasks/ahc032_a
 * Result: AC
 * Execution Time: 1929 ms
 */
...
static constexpr int MAX_OPT = 3;
...
struct Solver{
    ...
    void op3() {
        ...
        // それぞれ上位 10 通りを全探索
        rep(bs,min(10,(int)bottom_stamp.size())) rep(rs,min(10,(int)right_stamp.size())) {
