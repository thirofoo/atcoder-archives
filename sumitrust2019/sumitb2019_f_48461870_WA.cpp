/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/sumitrust2019/submissions/48461870
 * Submitted at: 2023-12-13 12:08:48
...
int main() {
    ...
    if( diff1*(diff1+diff2) > 0 ) return cout << 0 << endl, 0;
