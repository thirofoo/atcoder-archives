/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/sumitrust2019/submissions/48461908
 * Submitted at: 2023-12-13 12:11:09
...
int main() {
    ...
    if( diff1*(diff1+diff2) > 0 ) return cout << -1 << endl, 0;
