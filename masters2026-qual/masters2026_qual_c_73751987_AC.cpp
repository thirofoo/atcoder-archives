/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/masters2026-qual/submissions/73751987
 * Submitted at: 2026-03-01 18:50:41
...
int main() {
    ...
    // ============================================================
    {
        ...
        for (int restart = 0; restart < 500 && elapsed_ms() < 1900; restart++) {
            int num_states;
            ...
            double temp = 10.0;
            for (int it = 0; it < 10000 && elapsed_ms() < 1900; it++) {
