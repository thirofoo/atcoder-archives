/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc245/submissions/30496632
 * Submitted at: 2022-03-27 11:31:05
...
int main() {
    ...
    while(!todo.empty()){
        ...
        if(i)size.insert(P(y,x));
            ...
            //既にsizeに入っている箱は必ず縦の値においてはチョコより大きい
            // => 箱を横の長さでソートして小さいものを使っていくと効率よい。
