/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc286/submissions/50675723
 * Submitted at: 2024-02-27 15:06:29
...
int main() {
    ...
    while( T_info.size() > 1 ) {
        ...
        x *= (b2 - b1) % a2;
        ll next_a = a1 * a2;
        T_info.emplace_back(P(next_a, ( (a1*x+b1)%a1+next_a ) % next_a));
