/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/arc170/submissions/49557183
 * Submitted at: 2024-01-21 22:41:50
    ...
    rep(l,n) {
        ...
        for(ll d=-10; d<=10; d++) {
            for(ll a1=1; a1<=10; a1++) {
                ...
                auto it2 = lower_bound(dq[a2].begin(), dq[a2].end(), *it1);
                if( it2 == dq[a2].end() ) continue;
                auto it3 = lower_bound(dq[a3].begin(), dq[a3].end(), *it2);
