/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc389/submissions/61831954
 * Submitted at: 2025-01-18 22:32:19
 * Problem URL: https://atcoder.jp/contests/abc389/tasks/abc389_e
 * Result: WA
 * Execution Time: 1096 ms
 */
...
int main() {
  ...
  while(right - left > 1) {
    ...
    rep(i, n) {
      ...
      while(r2 - l2 > 1) {
        ll m2         = (l2 + r2) / 2;
        __int128 lhs  = (m2 - 1) * (m2 - 1) * p[i];
        __int128 rhs  = m2 * m2 * p[i];
