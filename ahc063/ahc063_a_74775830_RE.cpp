/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc063/submissions/74775830
 * Submitted at: 2026-04-09 00:00:39
 * Problem URL: https://atcoder.jp/contests/ahc063/tasks/ahc063_a
 * Result: RE
 * Execution Time: 1878 ms
 */
...
struct Solver {
    ...
    bool printAnswer() const {
        if ((int)movesDirs.size() >= 100) return false;
...
int main() {
    ...
    solver.readInput();
    solver.solve();
    if (!solver.printAnswer()) return 1;
    return 0;
}
