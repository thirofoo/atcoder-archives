/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc063/submissions/74703686
 * Submitted at: 2026-04-05 12:56:11
...
struct Solver {
    ...
    void solve() {
        ...
        while (state.turn < TURN_LIMIT) {
            ...
            // 2) If direct reach is impossible now, prioritize tail-follow movement.
            ...
            // 3) Wander to change environment and break loops.
            ...
            // 4) Timed self-cut (1..3 turns) only after enough stagnation.
            ...
            // 5) Randomized exploration (never freeze).
