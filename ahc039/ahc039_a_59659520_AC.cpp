/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc039/submissions/59659520
 * Submitted at: 2024-11-10 18:48:48
...
struct Solver {
  ...
  void solve() {
    ...
    rep(i, 91 * 2) SPACE_LEN_LIST.push_back(1000 + i * 50);
    rep(i, 10) masu_cnt_list.push_back(5 + i * 5);
