/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc273/submissions/35690738
 * Submitted at: 2022-10-15 22:28:21
 * Problem URL: https://atcoder.jp/contests/abc273/tasks/abc273_d
 * Result: RE
 * Execution Time: 1656 ms
 */
...
int main() {
    ...
    while(q--){
        ...
        if(ch == 'L'){
            auto itr = upper_bound(rr[rs].begin(),rr[rs].end(),w-cs-1);
            ...
            auto itr = upper_bound(cc[cs].begin(),cc[cs].end(),h-rs-1);
