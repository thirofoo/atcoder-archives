/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc257/submissions/32828948
 * Submitted at: 2022-06-29 14:57:35
...
int main() {
    ...
    rep(i,n){
        int ans = min(dfrom1[n],(d_tle_1 == INT_MAX || dfromn[i+1] == INT_MAX ? INT_MAX : d_tle_1+dfromn[i+1]));
        ans = min(ans,(d_tle_n == INT_MAX || dfrom1[i+1] == INT_MAX ? INT_MAX : d_tle_n+dfrom1[i+1]));
        ans = min(ans,(d_tle_n == INT_MAX || d_tle_1 == INT_MAX ? INT_MAX : d_tle_n+d_tle_1));
