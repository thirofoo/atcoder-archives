/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc367/submissions/56839679
 * Submitted at: 2024-08-18 00:29:11
...
struct Zobrist_hash_set {
  ...
  void flip(const S &x) {
    if(!x_to_hash.count(x)) x_to_hash[x] = rnd[id++];
    v ^= x_to_hash[x];
  }
