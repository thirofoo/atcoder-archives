/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc324/submissions/47610960
 * Submitted at: 2023-11-16 14:05:52
...
int main() {
    ...
    sort(l.begin(), l.end());
    sort(r.begin(), r.end());
    rep(i,n) ans += r.end() - lower_bound(r.begin(),r.end(),t.size()-l[i]);
    cout << ans << endl;
