/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc088/submissions/46474268
 * Submitted at: 2023-10-12 19:13:47
...
int main() {
    ...
    while( !todo.empty() ) {
        ...
        rep(d,4) {
            ...
            if( outField(nx,ny,h,w) || vis[nx][ny] != -1 || s[nx][ny] == '#' ) continue;
