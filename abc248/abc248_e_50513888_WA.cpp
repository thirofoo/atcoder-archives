/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc248/submissions/50513888
 * Submitted at: 2024-02-22 18:58:23
...
struct Line {
    ...
    // 演算子 overload (sort用)
    constexpr bool operator<(const Line& l) const noexcept { return tuple(this->a,this->b,this->c) < tuple(l.a,l.b,l.c); }
    constexpr bool operator>(const Line& l) const noexcept { return tuple(this->a,this->b,this->c) > tuple(l.a,l.b,l.c); }
    constexpr bool operator==(const Line& l) const noexcept { return this->a == l.a && this->b == l.b && this->c == l.c; }
};
