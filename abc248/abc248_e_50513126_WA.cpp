/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc248/submissions/50513126
 * Submitted at: 2024-02-22 18:22:04
...
struct Line {
    ...
    // 演算子 overload (sort用) 
    bool operator<  (Line &l) { return tuple(a,b,c) < tuple(l.a,l.b,l.c);}
    bool operator>  (Line &l) { return tuple(a,b,c) < tuple(l.a,l.b,l.c);}
    bool operator== (Line &l) { return a == l.a && b == l.b && c == l.c;}
};
