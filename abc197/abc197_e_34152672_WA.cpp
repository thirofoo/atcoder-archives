/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc197/submissions/34152672
 * Submitted at: 2022-08-20 11:18:18
    ...
    rep(i,n){
        rep(j,2){
            ...
            if(!ball[i].empty()){
                ...
                dp[i+1][0] = min(P(c,now),dp[i+1][0]);
                dp[i+1][1] = min(P(c,now),dp[i+1][1]);
            }
        }
    }
