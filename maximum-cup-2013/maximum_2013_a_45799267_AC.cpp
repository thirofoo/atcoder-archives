/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/maximum-cup-2013/submissions/45799267
 * Submitted at: 2023-09-23 00:05:54
...
int main() {
    ...
    for (i=1; i<N; i++) {
        ...
        for (i2=1; i2<=ki; k=lk[i2++]) {
            K = i | 1 << k;
            for (i1=1; i1<=ji; j=lj[i1++]) {
