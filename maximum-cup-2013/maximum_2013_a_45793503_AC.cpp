/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/maximum-cup-2013/submissions/45793503
 * Submitted at: 2023-09-22 19:54:09
...
int main() {
    ...
    for (uint i=1; i<N; i++) {
        ...
        for (uint j=lj[0], i1=1; i1<=ji; j=lj[i1++]) {
            for (uint k=lk[0], i2=1; i2<=ki; k=lk[i2++]) {
                if( i & 1 << k ) continue;
                K = i | 1 << k;
