/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/zone2021/submissions/54411272
 * Submitted at: 2024-06-09 23:07:06
 * Problem URL: https://atcoder.jp/contests/zone2021/tasks/zone2021_c
 * Result: WA
 * Execution Time: 1296 ms
 */
...
int main() {
	...
	rep(i, n) reps(j, i+1, n) {
		...
		rep(k, 5) {
			...
			bit |= (1LL << idx);
			auto itr = lower_bound(power_min[bit].begin(), power_min[bit].end(), P(pv, -1));
