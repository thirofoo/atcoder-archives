/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc129/submissions/29180943
 * Submitted at: 2022-02-09 19:06:11
...
int main() {
    ...
    rep(i,h){
        rep(j,w){
            ...
            int itr_x = lower_bound(obs_x[i+1].begin(),obs_x[i+1].end(),i+1) - obs_x[i+1].begin(); 
            int itr_y = lower_bound(obs_y[j+1].begin(),obs_y[j+1].end(),j+1) - obs_y[j+1].begin();
