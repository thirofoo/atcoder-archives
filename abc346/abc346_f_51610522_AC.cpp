/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc346/submissions/51610522
 * Submitted at: 2024-03-23 22:44:23
...
int main() {
    ...
    while( right - left > 1 ) {
        ...
        rep(i,t.size()) {
            ...
            if( mid == after_num ) now = idx[t[i]-'a'][next_idx] + 1;
            else if( mid < after_num ) {
