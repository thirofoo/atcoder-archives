/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/masters2025-qual/submissions/63336235
 * Submitted at: 2025-03-02 18:26:46
 * Problem URL: https://atcoder.jp/contests/masters2025-qual/tasks/masters2025_qual_c
 * Result: RE
			...
			rep(i, N) rep(j, N) {
				...
				while(!que.empty()) {
					...
					rep(k, DIR_NUM) {
						...
						if(outField(next) || visited[next.x][next.y] || (!use_rock_flag[next.x][next.y] && field[next.x][next.y] == '@')) continue;
