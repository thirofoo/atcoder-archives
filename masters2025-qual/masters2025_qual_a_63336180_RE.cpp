/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/masters2025-qual/submissions/63336180
 * Submitted at: 2025-03-02 18:25:23
  ...
  void solve() {
		...
		while(carried_cnt < 2 * N) {
			...
			rep(i, N) rep(j, N) {
				bool ng = true;
				rep(d, DIR_NUM) {
					Point next = Point(i, j) + delta[d];
					if(outField(next)) continue;
