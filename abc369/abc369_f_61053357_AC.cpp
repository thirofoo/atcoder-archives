/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc369/submissions/61053357
 * Submitted at: 2024-12-24 15:50:45
...
int main() {
  ...
  cin >> h >> w >> n;
  vector<ll> r(n), c(n);
  vector<vector<P>> row_group(size);
  rep(i, n) {
    cin >> r[i] >> c[i];
    row_group[r[i]].emplace_back(P(c[i], i));
  }
