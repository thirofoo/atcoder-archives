/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc025/submissions/46847815
 * Submitted at: 2023-10-22 14:15:50
 * Problem URL: https://atcoder.jp/contests/ahc025/tasks/ahc025_a
 * Result: AC
 * Execution Time: 673 ms
 */
...
struct Solver {
    ...
    inline void generateRest(vector<int>& rest) {
        ...
        if( left.size() > 3 && state.q >= 8*n ) generateRest(left);
