/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc055/submissions/44019776
 * Submitted at: 2023-07-29 10:37:24
...
int main() {
    ...
    rep(i,4) {
        ...
        // 1文字目が題意を満たすか否か
        bool f = false;
        f |= (s[0] == 'o' && first_ch == 'S' && first == second_ch);
        f |= (s[0] == 'o' && first_ch == 'W' && first != second_ch);
        f |= (s[0] == 'x' && first_ch == 'S' && first != second_ch);
        f |= (s[0] == 'x' && first_ch == 'W' && first == second_ch);
