/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc289/submissions/48500181
 * Submitted at: 2023-12-15 10:06:52
 * Problem URL: https://atcoder.jp/contests/abc289/tasks/abc289_e
 * Result: AC
 * Execution Time: 1163 ms
 */
        ...
        while( !todo.empty() ) {
            ...
            for(auto to1:Graph[v1]) {
                for(auto to2:Graph[v2]) {
                    if( vis[to1][to2][c[to1]][c[to2]] <= dis+1 || c[to1] == c[to2] ) continue;
