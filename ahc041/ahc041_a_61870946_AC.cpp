/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc041/submissions/61870946
 * Submitted at: 2025-01-19 18:57:24
...
struct Solver {
  ...
  void solve() {
    ...
    while(utility::mytm.elapsed() < TIME_LIMIT) {
      rep(i, N) {
        auto && [x, y] = places[i];
        rands[i] = rand_int() % 50 + A[i] + sqrt((x - 500) * (x - 500) + (y - 500) * (y - 500)) / 10;
      }
