/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc012/submissions/32984253
 * Submitted at: 2022-07-04 21:01:38
 * Problem URL: https://atcoder.jp/contests/ahc012/tasks/ahc012_a
 * Result: AC
 * Execution Time: 2970 ms
 */
...
inline double temp(int start) {
    ...
    double start_temp = 700,end_temp = 200;
...
int main(){
    ...
    while(utility::mytm.elapsed() <= 2950){
        //どの線を選ぶか
        int l = rand_int()%70,add = (int)(rand_int()%(20000/70))-20000/70/2;
