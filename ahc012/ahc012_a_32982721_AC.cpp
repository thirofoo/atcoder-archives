/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc012/submissions/32982721
 * Submitted at: 2022-07-04 19:17:34
...
int main(){
    ...
    while(utility::mytm.elapsed() <= 2950){
        //どの線を選ぶか
        int l = rand_int()%80,add = (int)(rand_int()%(20000/80))-20000/80/2;
