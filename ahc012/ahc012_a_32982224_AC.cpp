/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc012/submissions/32982224
 * Submitted at: 2022-07-04 18:42:36
...
int main() {
    ...
    while(utility::mytm.elapsed() <= 2950){
        ...
        if(rand_int()%5 != 0 || k == 0){
            ...
            else line2.erase(lower_bound(line2.begin(),line2.end(),T(0,y,1,y)));
        }
    }
