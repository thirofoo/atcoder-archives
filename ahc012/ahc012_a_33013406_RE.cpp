/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc012/submissions/33013406
 * Submitted at: 2022-07-06 13:22:12
...
void CalcDiff(){
    l = rand_int()%69,add = (int)(rand_int()%(20000/70))-(20000/70/2);
...
int main(){
    ...
    //直線移動part
    while((cnt++)%1000 != 0 || utility::mytm.elapsed() <= 9950){
        CalcDiff();
    }
