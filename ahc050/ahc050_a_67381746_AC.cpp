/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/ahc050/submissions/67381746
 * Submitted at: 2025-07-06 19:25:01
...
struct Solver {
    ...
    void solve() {
        ...
        for (int k = 0; k < num_placements; ++k) {
            ...
            if (best_cell.first == -1) { // In case all remaining are equally likely (e.g., prob=0)
                for(const auto& cell : initial_empty_cells) {
