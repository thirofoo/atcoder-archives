/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc247/submissions/37602559
 * Submitted at: 2022-12-28 23:12:15
...
int main() {
    ...
    rep(left,n){
        ...
        bool f = false;
        if(a[left] == y)y_idx.pop_front();
        if(a[left] == x)x_idx.pop_front();
        if(left == right)right++;
    }
    print(ans);
