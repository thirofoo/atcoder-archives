/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc353/submissions/65298362
 * Submitted at: 2025-04-28 02:25:28
...
struct Trie {
  ...
  // LPS (Longest Prefix Suffix) の長さの総和
  inline ll lps(const string& s) const {
    int u  = 0;
    ll ans = 0;
    for(char ch: s) {
      int c = ch - MinChar;
