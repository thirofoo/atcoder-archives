/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc199/submissions/61303981
 * Submitted at: 2025-01-02 00:51:04
...
int main() {
  ...
  auto dfs2 = [&](auto self, ll idx) -> void {
    ...
    if(idx + 1 == group.size()) {
      cand += 3 - __builtin_popcount((unsigned long) c_bit);
      return;
    }
    vis_cnt++;
    rep(nc, 3) {
