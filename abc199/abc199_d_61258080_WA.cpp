/*
 * Author: through
 * Submission URL: https://atcoder.jp/contests/abc199/submissions/61258080
 * Submitted at: 2024-12-31 00:48:42
...
int main() {
  ...
  for(auto group: groups) {
    ll cand = 0, cnt = 0;
    set<ll> st;
    auto dfs = [&](auto self, ll now, ll situation) -> void {
      for(auto nc: {0, 1, 2}) {
        bool ng = false;
